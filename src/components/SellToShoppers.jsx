      ...
      <div className="container mx-auto">
        <div className="flex flex-wrap justify-center items-center">
          <div className="xl:w-4/12 w-full">
            <div className="lg:py-[22px] xl:max-w-[367px] relative lg:max-w-3xl md:max-w-2xl max-w-lg max-xl:mx-auto md:py-4 py-3 lg:px-5 md:px-4 px-3 green-gradient rounded-2xl xl:min-h-[365px]">
              <CustomHeading styleclass='xl:!text-[40px] lg:!leading-[112%] xl:max-w-[307px] lg:text-3xl md:!text-2xl !text-xl !font-semibold lg:mb-4 md:mb-3 mb-2' title='Sell to shoppers wherever they are' />
              ...
              <Image className=' absolute pointer-events-none -z-10 -bottom-16 lg:block max-lg:hidden left-0 w-full' src='/assets/images/webp/green-bg-shadow.webp' width={336} height={372} alt='shadow-img'/>
            </div>
          </div>
          <div className="xl:w-8/12 w-full xl:pt-0 md:pt-10 pt-7 lg:pl-8 mx-auto max-xl:justify-center flex items-center">
            <div className="flex xl:gap-x-[36px] lg:gap-x-36 md:gap-x-10 max-xl:justify-center items-center lg:gap-y-[62px] md:gap-y-14 sm:gap-y-12 gap-y-10 flex-wrap">
              ...
              {SHOPPERS_CARDS_LIST.map((item, index) => (
                <div className="max-w-[323px] backdrop-blur w-full gap-4 items-center flex" key={index} data-aos="fade-left" data-aos-delay={index * 100} data-aos-duration="500">
