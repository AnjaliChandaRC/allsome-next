          ...
          <div className="flex flex-wrap">
            <div className="lg:w-6/12 w-full lg:pt-[114px] lg:pb-[130px] max-lg:py-10 3xl:pb-44 max-md:pt-14 max-md:pb-10 relative">
              ...
              <div className="relative z-20">
                ...
                <CustomDescription styleclass="xl:mb-[34px] lg:mb-7 md:mb-5 mb-4 max-lg:text-center max-lg:mx-auto xl:max-w-[460px] max-w-[400px] xl:!text-xl lg:!text-lg md:!text-base !text-sm" description="Turn your inventory into sales channel. Sell more stuff everywhere" />
                <div className="flex gap-2 max-lg:justify-center">
                  <CustomButton styleclass='xl:!py-[16.5px] xl:!h-14 xl:!max-w-[185px] sm:!max-w-40 !max-w-36 xl:w-full lg:!py-3 !py-2 xl:!px-[34.5px] !bg-black text-white hover:!bg-transparent hover:text-black' title='Sign up for free' />
                  <a href="https://web.whatsapp.com/" target='_blank'> <CustomButton styleclass='xl:!py-[14.5px] xl:!h-14 xl:!max-w-[170px] sm:!max-w-40 !max-w-36 xl:w-full lg:!py-3 !py-2 xl:!px-[25px] hover:!bg-black before:!bg-black hover:text-white group' styleclassTwo='!block whatsapp-icon transiction-all ease-in-out duration-300' icon={<WhatsAppLogo />} title='Whatsapp us' /></a>
                </div>
              </div>
            </div>
            <div className="lg:w-6/12 w-full lg:pt-10">
              ...
              <Image data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000" className='shadow-[25px_-20px_60px_0px_#0000001A] pointer-events-none xl:min-w-[318px] w-full lg:block max-lg:hidden rounded-[29px] lg:max-w-64 lg:absolute xl:!translate-x-8 lg:!-translate-x-10 xl:-bottom-16 -bottom-7' src='/assets/images/webp/hero-mobile-img.webp' width={318} height={430} alt='mobile-img' />
              <div className="max-lg:relative justify-center flex">
                ...
                <Image className='max-lg:block pointer-events-none lg:hidden w-full z-50 md:max-w-44 sm:max-w-32 max-w-28 absolute md:top-44 sm:top-12 top-[90px] md:left-0 sm:left-7 left-3' src='/assets/images/webp/mobile-screen-img-2.webp' width={318} height={430} alt='mobile-img' />
              </div>
            </div>
          </div>
        </div>
