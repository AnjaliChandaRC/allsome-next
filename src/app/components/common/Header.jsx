  ...
  return (
    <div className="flex justify-between flex-col w-full">
      ...
      <div className="container flex justify-between w-full mx-auto lg:pt-[13px] pt-4 items-center">
        <button onClick={handleOpen} className={`hidden size-7 justify-center items-center max-lg:absolute max-lg:right-5 relative z-[70] max-lg:flex flex-col overflow-hidden`}>
          <span className={`w-6 transition-all duration-300 min-h-[2.2px] max-h-[2px] mb-1 bg-black relative after:w-full after:h-full  after:absolute after:top-0 after:left-0 ${open ? "rotate-45 after:rotate-90 after:bg-white !bg-white" : ""}`}></span>
          <span className={`w-6 transition-all duration-300 min-h-[2.4px] max-h-[2px] mb-1 bg-black ${open ? "hidden" : ""}`}></span>
          <span className={`w-6 transition-all duration-300 min-h-[2.2px] max-h-[2px] mb-1 bg-black after:!bg-white ${open ? "-translate-x-10 !bg-white" : ""}`}></span>
        </button>
        <Link href="/">
        ...
        <div className="lg:block max-lg:hidden  ">
          <div className="flex gap-2.5 w-full">
            <CustomButton CustomOnClick={handleOpen} styleclass='lg:!py-[8.5px] !py-1.5 hover:!bg-black before:!bg-black hover:text-white  !px-0 max-w-24' title='Log in' />
