  ...
  return (
    <div className="flex justify-between flex-col w-full">
      <div className="w-full bg-black">
        <div className={`container flex justify-between w-full mx-auto py-[9px] items-center max-xl:px-6`}>
      ...
      <div className="container flex justify-between w-full mx-auto lg:pt-[13px] pt-4 items-center max-xl:px-6">
        ...
        <div className={`flex xl:gap-[39px] items-center max-lg:px-4 relative w-full max-lg:bg-black mx-auto lg:gap-7 gap-6 !text-black lg:max-h-max max-lg:fixed max-lg:top-0 max-lg:h-full max-lg:w-full max-lg:flex-col max-lg:bg-hero-pattern max-lg:duration-300 justify-center max-lg:items-center z-[60] ${open ? "max-lg:left-0" : "max-lg:left-full"}`}>
          {HEADER_LIST.map((item, index) => (
            <a onClick={handleOpen} key={index} href={item.link} className="relative text-sm font-medium text-black transition-all duration-300 ease-linear group"> {item.title}
          ...
          <div className="lg:hidden max-lg:block">
            <div className="flex flex-col gap-2.5">
              <CustomButton CustomOnClick={handleOpen} styleclass='lg:!py-[8.5px] !py-1.5' title='Log in' />
              <CustomButton CustomOnClick={handleOpen} styleclass='lg:!py-[8.5px] !py-1.5 !bg-black text-white hover:!bg-transparent hover:text-black' title='Start free' />
            </div>
          </div>
        </div>
