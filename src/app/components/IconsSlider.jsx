...
const IconsSlider = () => {
  return (
    <div className='max-3xl:bg-white-pattern 3xl:bg-white icon-slider overflow-hidden bg-cover w-full bg-center xl:pt-[147px] pt-20 xl:pb-[164px] lg:pb-20 md:pb-[60px] pb-[30px] -mt-16 md:-mt-28 2xl:-mt-32 relative z-[50] bg-no-repeat'>
      <div className="container">
        <CustomSlider dataList={ICON_SLIDER_LIST} classStyle='!gap-[39px] md:!hidden max-md:!block' customClassStyle='min-w-[100px] h-auto !max-w-[110px]' />
