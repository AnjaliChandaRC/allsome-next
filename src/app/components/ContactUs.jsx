  ...
  return (
    <div className="overflow-hidden">
      <div className='container xl:pt-[67px]'>
        ...
        <div className="flex xl:pb-[300px] md:pb-[100px] sm:pb-16 pb-10 justify-center max-xl:flex-col-reverse max-xl:flex-wrap xl:gap-16 ">
          ...
          <div className="relative w-full xl:w-6/12 max-xl:mb-12 max-sm:mb-8">
            <Image className='z-[-1] translate-y-[55px] absolute max-xl:hidden xl:right-[-35%] rounded-l-[40px] h-[593px] max-w-[740px] w-full' width={740} height={593} src="/assets/images/webp/contact-green-box.webp" alt='contact green box' />
