  ...
  return (
    <div className='lg:pt-[89px] lg:pb-[76px] md:py-14 py-12 max-w-[1920px] mx-auto relative'>
     <Image
                  ...
                  width={471}
                  height={241}
                  className='object-cover lg:block hidden sm:max-w-[300px] max-sm:h-[200px] max-w-[100px] lg:max-w-[471px] w-full absolute left-0 lg:top-[43%] z-10'
                  alt="ellipse-left"
      />
      <Image
        ...
        width={471}
        height={241}
        className='object-cover lg:block hidden sm:max-w-[300px] max-w-[100px] max-sm:h-[200px] lg:max-w-[471px] w-full absolute right-0 lg:top-[43%] z-10'
        alt="ellipse-right"
      />
