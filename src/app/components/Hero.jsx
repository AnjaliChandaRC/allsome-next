        ...
        <div className="container mx-auto">
          <div className="flex flex-wrap">
            ...
            <div className="lg:w-6/12 w-full lg:pt-10">
              ...
              <Image data-aos="fade-up" data-aos-delay={200} data-aos-duration="500" className='shadow-[25px_-20px_60px_0px_#0000001A] pointer-events-none xl:max-w-[318] lg:block max-lg:hidden rounded-[29px] lg:max-w-64 lg:absolute xl:!translate-x-8 lg:!-translate-x-10 xl:-bottom-16 -bottom-10' src='/assets/images/webp/hero-mobile-img.webp' width={318} height={430} alt='mobile-img' />
