        ...
        <div className="container mx-auto ">
          <div className="flex flex-wrap">
            ...
            <div className="lg:w-6/12 w-full lg:pt-10">
              <Image className='shadow-custom-1 lg:block max-lg:hidden xl:max-w-[635px] rounded-md lg:max-w-lg lg:absolute right-0' src='/assets/images/webp/hero-location-img.webp' width={635} height={543} alt='location-img' />
              <Image className='shadow-custom-1 xl:max-w-[318] lg:block max-lg:hidden rounded-[29px] lg:max-w-64 lg:absolute translate-x-8 -bottom-20 bounce-in-right' src='/assets/images/webp/hero-mobile-img.webp' width={318} height={430} alt='mobile-img' />
