          ...
          <div className="flex flex-wrap">
            ...
            <div className="lg:w-6/12 w-full">
              ...
              <div className="max-lg:relative justify-center flex">
                ...
                <Image className='max-lg:block lg:hidden w-full z-50 md:max-w-44 sm:max-w-32 max-w-28 absolute md:top-14 sm:top-12 top-10 sm:-left-10 floatStar left-4' src='/assets/images/webp/mobile-screen-img-2.png' width={635} height={543} alt='mobile-img' />
              </div>
            </div>
          </div>
        </div>
