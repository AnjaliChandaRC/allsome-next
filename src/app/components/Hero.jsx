      ...
      <div className="relative max-w-[1440px] w-full mx-auto">
        <div className="container mx-auto">
          <div className="flex flex-wrap">
            <div className="lg:w-6/12 w-full lg:pt-[114px] lg:pb-[130px] max-lg:py-10 max-md:pt-14 max-md:pb-10 relative">
              ...
              <div className="relative z-20">
                ...
                <div className="flex gap-2 max-lg:justify-center">
                  ...
                  <CustomButton styleclass='xl:!py-[14.5px] lg:!py-3 !py-2 xl:!px-[25px] hover:!bg-black before:!bg-black hover:text-white group' styleclassTwo='!block whatsapp-icon transiction-all ease-in-out duration-300' icon={<WhatsAppLogo />} title='Whatsapp us' />
                </div>
              </div>
            </div>
            <div className="lg:w-6/12 w-full lg:pt-10">
              ...
              <Image data-aos="fade-up" data-aos-delay={200} data-aos-duration="500" className='shadow-[25px_-20px_60px_0px_#0000001A] pointer-events-none xl:max-w-[318] lg:block max-lg:hidden rounded-[29px] lg:max-w-64 lg:absolute translate-x-8 xl:-bottom-16 -bottom-10 bounce-in-right' src='/assets/images/webp/hero-mobile-img.webp' width={318} height={430} alt='mobile-img' />
