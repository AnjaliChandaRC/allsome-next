        ...
        <div className="container mx-auto ">
          <div className="flex flex-wrap">
            <div className="lg:w-6/12 w-full lg:py-[114px] py-10 relative">
              <Image className='absolute pointer-events-none xl:-left-32 left-0 e-commerce-box-icon max-md:top-20 xl:max-w-40 lg:max-w-32 md:max-w-24 max-w-20 opacity-80 w-full' src='/assets/images/webp/hero-ellipse-img-1.webp' width={213} height={230} alt='ellipse-img-1' />
              ...
              <div className="relative z-20">
                <h1 className='uppercase lg:mb-2.5 mb-1.5 font-kanit max-lg:text-center max-lg:mx-auto text-black font-extrabold xl:text-custom-6xl lg:text-custom-5xl md:text-custom-4xl sm:text-custom-3xl text-custom-2xl max-w-[579px] !leading-[100%] text-start'>SELL & SHIP EVERYWHERE</h1>
            ...
            <div className="lg:w-6/12 w-full lg:pt-10">
              ...
              <Image className='shadow-custom-1 pointer-events-none xl:max-w-[318] lg:block max-lg:hidden rounded-[29px] lg:max-w-64 lg:absolute translate-x-8 -bottom-20 bounce-in-right' src='/assets/images/webp/hero-mobile-img.webp' width={318} height={430} alt='mobile-img' />
