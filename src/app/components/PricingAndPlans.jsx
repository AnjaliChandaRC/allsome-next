...
const PricingAndPlans = () => {
  ...
  return (
    <div id='pricing' className="container sm:pb-10 md:pb-[66px] lg:pt-20 max-sm:py-[30px] max-xl:pt-20 max-lg:pt-[60px] max-md:pt-10 max-sm:pt-[30px]">
      ...
      <div className="flex xl:gap-[39px] gap-4 max-lg:flex-wrap justify-center">
        {PRICING_DATA_LIST.map((card, index) => (
          <div key={index} className={`w-full relative max-w-[303px] rounded-2xl sm:py-[31px] py-5 bg-cover bg-center hover:shadow-[0px_1px_5px_5px_#36eb58] transition-all duration-300 ease-linear bg-no-repeat ${index === 1 ? "bg-pricing-table" : " border-2 border-black/20 hover:border-transparent "} `}>
