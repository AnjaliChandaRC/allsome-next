    ...
    <div className="bg-cover bg-no-repeat bg-center h-[606px] max-xl:h-full max-xl:p-24 max-lg:p-20 max-md:p-16 max-sm:p-12 rounded-[40px] bg-e-commerce relative overflow-hidden">
      ...
      <div className="pt-[88px] max-xl:pt-0 relative z-20">
        <CustomHeading
          ...
          style="!text-white text-center max-w-[761px] mx-auto"
        />
        ...
        <div className="flex items-center justify-center gap-[21px] mt-[38px]">
          <CustomButton
            style="!text-white py-[14px h-[52px] flex items-center justify-center border border-solid border-white rounded-full min-w-[172px] e-commerce-btn"
            title="Sign up today"
          />
          <CustomButton
            style="!text-white py-[14px] border h-[52px] flex items-center justify-center border-solid border-white rounded-full min-w-[171px] e-commerce-btn"
