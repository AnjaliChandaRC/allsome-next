  ...
  return (
    <div className='bg-light-green lg:rounded-[40px] rounded-[20px] lg:py-[112px] py-10 md:py-[60px]'>
      <div className='container lg:max-w-[1109px] mx-auto'>
        <div className='lg:flex-row flex justify-between flex-col gap-7'>
          ...
          <div data-aos="fade-left" className='lg:w-[483px] w-full flex flex-col lg:items-start items-center justify-center'>
            <CustomHeading styleclass="lg:max-w-[482px] xl:!leading-custom-14xl xl:!text-custom-5xl lg:!text-custom-3xl md:!text-4xl !text-2xl font-kanit font-semibold sm:pb-7 pb-4 max-lg:text-center" title={'Automate your operations'} />
